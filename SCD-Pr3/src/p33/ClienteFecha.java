...
public class ClienteFecha {
    ...
    public static void main(String args[]) {
        try {
            ...
            // Vamos a necesitar leer el nombre de la m�quina en la que
             ...
             * un "string" el nombre de la m�quina servidora, el numero de 
             * puerto y, al final, el nombre simbolico del servicio que se 
             * implementa con del objeto distribuido.
             */
            String URLServidor = "rmi://"+nombreHost+":"+numeroPuerto+"/fecha";
             ...
             */
            DiaDelaFechaInterface Interfaz = (DiaDelaFechaInterface)Naming.lookup(URLServidor);
             ...
             * patalla local.
             */
            System.out.println(Interfaz.getDaytime());
        } catch (Exception e) {
