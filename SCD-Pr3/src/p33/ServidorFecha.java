...
public class ServidorFecha {
    ...
    public static void main(String args[]) {
        ...
        String numeroPuerto, registroURL, nombreHost;
        ...
        try {
             ...
             */
            registroURL = ("rmi://<localhost>:" + numeroPuertoRMI + "<numo.puerto>/<" + numeroPuerto + ". Fechas Miguel le ofrece: " + fecha);
            
            /**
             * Ligar el registro RMI con la referencia anterior del objeto 
             * "implHola"
             */
            Naming.rebind(registroURL, fecha);
            //rebind
    ...
    private static void listarRegistro(String registroURL)
         ...
         */
        System.out.println("El expléndido registro " + registroURL +" contiene: ");
